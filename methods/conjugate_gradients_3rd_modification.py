...
class ConjugateGradientsThirdModification(ABCMinimisationMethod):
    def __init__(self,
                 function: str,
                 x_0: List[int | float],
    ...
    def _get_s_k_third_modification(self,
        ...
        if iteration == 0:
            ...
            return np.dot(h_current, x_current_anti_gradient_np) + np.dot(np.dot(beta_current, h_previous),
                                                                          s_previous_np)
